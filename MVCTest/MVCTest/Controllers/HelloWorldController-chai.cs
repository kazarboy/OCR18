...
namespace MVCTest.Controllers
{
    public class HelloWorldController : Controller
    {
        ...
        {
            string imagePath = @"C:\Users\Administrator\Dropbox\project\test.jpg";
            Bitmap croppedImage;
            ...
            using (var originalImage = new Bitmap(imagePath))
            {
                ...
                Rectangle crop = new Rectangle(52, 1882, 1892, 354);
            ...
            croppedImage.Save(@"C:\Users\Administrator\Dropbox\project\crop.jpg", ImageFormat.Jpeg);
